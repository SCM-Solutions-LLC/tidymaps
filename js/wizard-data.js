...
export const SETUP_TYPES = {
  ...
  closet: [
    ...
    { id: 'builtin', label: 'Built-in + drawers', desc: 'Shelves up top, drawers below', artKey: 'artBuiltinDrawers' },
  ],
  dresser: [
...
const ART = {
  ...
  /* Built-in reads as recessed joinery — flush carcass with no legs, folded
     stock on a top shelf, a short hang rail, and a drawer bank below. The
     freestanding wardrobe above keeps the legs and full-height doors, so the
     two closet options are no longer the same drawing. */
  artBuiltinDrawers: '<rect x="12" y="4" width="72" height="62" fill="#fff"/><path d="M12 21h72M52 21v45M12 38h40"/><rect x="17" y="11" width="14" height="4" rx="2" fill="#ffe1d0"/><rect x="18" y="16" width="12" height="4" rx="2" fill="#f0fae1"/><rect x="38" y="12" width="12" height="4" rx="2" fill="#fff"/><rect x="39" y="17" width="10" height="3" rx="1.5" fill="#ffe1d0"/><rect x="60" y="11" width="16" height="9" rx="2" fill="#f0fae1"/><path d="M17 28h30"/><path d="M40 28v4"/><path d="M40 32l-4 3-3-2-2 4 5 3v9h8V40l5-3-2-4-3 2z" fill="#f0fae1"/><rect x="56" y="41" width="24" height="7" rx="1.5" fill="#fff8ef"/><rect x="56" y="50" width="24" height="7" rx="1.5" fill="#fff8ef"/><path d="M64 44.5h8M64 53.5h8"/>',
...
const ART_MOTION = {
  ...
  /* Drawer, not a shirt: the built-in's motion has to differ from the
     wardrobe's or the two cards still read as the same option. */
  artBuiltinDrawers: drawerMotion(56, 59, 24, 7),
