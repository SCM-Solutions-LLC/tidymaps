  ...
  return {
    ...
    map: [
      {level: 'Top shelf', icon: 'up', zone: 'Bulk overflow · Backup paper goods · Rarely used items',
        ...
        items: [{name: 'Bulk overflow', size: 'l', flags: ['heavy']}, {name: 'Paper goods', size: 'l', flags: []}, {name: 'Rarely used', size: 'm', flags: []}], surface: 'shelf'},
      {level: 'Eye level', icon: 'eye', zone: 'Daily snacks · Breakfast items · Coffee or tea',
        ...
        items: [{name: 'Daily snacks', size: 'm', flags: ['kid-frequent']}, {name: 'Breakfast', size: 'm', flags: []}, {name: 'Coffee & tea', size: 's', flags: []}], surface: 'shelf'},
      {level: 'Middle shelf', icon: 'middle', zone: 'Canned goods · Pasta · Grains · Dinner ingredients',
        ...
        safety: {flag: null, why: null},
        items: [{name: 'Canned goods', size: 'm', flags: ['heavy']}, {name: 'Pasta & grains', size: 'm', flags: []}, {name: 'Dinner ingredients', size: 'm', flags: []}], surface: 'shelf'},
      {level: 'Lower shelf', icon: 'down', zone: 'Heavy items · Kid-friendly snacks · Large containers',
        ...
        items: [{name: 'Heavy items', size: 'l', flags: ['heavy']}, {name: 'Kid snacks', size: 's', flags: ['kid-frequent']}, {name: 'Large containers', size: 'l', flags: []}], surface: 'shelf'},
  ...
  return {
    ...
    map: [
      {level: 'Top shelf', icon: 'up', zone: 'Serving dishes · Rarely used glassware',
        ...
        items: [{name: 'Serving dishes', size: 'l', flags: ['heavy', 'fragile']}, {name: 'Specialty glasses', size: 'm', flags: ['fragile']}], surface: 'shelf'},
      {level: 'Eye level', icon: 'eye', zone: 'Daily plates · Bowls · Glasses',
        ...
        eye: true, shelfIndex: 1,
        safety: {flag: null, why: null},
        items: [{name: 'Dinner plates', size: 'l', flags: ['heavy']}, {name: 'Bowls', size: 'm', flags: []}, {name: 'Everyday glasses', size: 'm', flags: ['fragile']}], surface: 'shelf'},
      {level: 'Lower shelf', icon: 'down', zone: 'Mugs · Food storage · Baking sheets',
        ...
        eye: false, shelfIndex: 2,
        safety: {flag: null, why: null},
        items: [{name: 'Mugs', size: 's', flags: ['kid-frequent']}, {name: 'Food storage', size: 'm', flags: []}, {name: 'Baking sheets', size: 'l', flags: ['heavy']}], surface: 'shelf'}
    ],
  ...
  return {
    ...
    map: [
      {level: 'Top shelf', icon: 'up', zone: 'Seasonal items · Luggage · Out-of-rotation clothes',
        ...
        items: [{name: 'Seasonal boxes', size: 'l', flags: ['heavy']}, {name: 'Luggage', size: 'l', flags: ['heavy']}, {name: 'Hat boxes', size: 'm', flags: []}], surface: 'shelf'},
      {level: 'Hanging rod: left', icon: 'eye', zone: 'Work clothes · Blazers · Dress shirts',
        ...
        eye: true, shelfIndex: 1,
        safety: {flag: null, why: null},
        items: [{name: 'Work shirts & blouses', size: 'm', flags: []}, {name: 'Blazers & jackets', size: 'l', flags: []}, {name: 'Dress pants & skirts', size: 'm', flags: []}], surface: 'rod'},
      {level: 'Hanging rod: right', icon: 'middle', zone: 'Casual wear · Weekend clothes · Workout gear',
        ...
        eye: false, shelfIndex: 2,
        safety: {flag: null, why: null},
        items: [{name: 'Casual tops', size: 'm', flags: ['kid-frequent']}, {name: 'Jeans & casual pants', size: 'm', flags: []}, {name: 'Workout gear', size: 's', flags: []}], surface: 'rod'},
  ...
  return {
    ...
    map: [
      {level: 'Top shelf', icon: 'up', zone: 'Chemicals · Paint · Solvents · Hazardous items',
        ...
        items: [{name: 'Paint & stain', size: 'm', flags: ['chemical']}, {name: 'Solvents & cleaners', size: 's', flags: ['chemical']}, {name: 'Spray products', size: 's', flags: ['chemical']}], surface: 'shelf'},
      {level: 'Upper shelf', icon: 'layers', zone: 'Holiday decorations · Seasonal items',
        ...
        safety: {flag: null, why: null},
        items: [{name: 'Holiday boxes', size: 'l', flags: []}, {name: 'Seasonal lights', size: 'm', flags: ['fragile']}, {name: 'Wreath storage', size: 'l', flags: []}], surface: 'shelf'},
      {level: 'Eye level', icon: 'eye', zone: 'Frequently used tools · Hardware · Tape & glue',
        ...
        safety: {flag: null, why: null},
        items: [{name: 'Tool box', size: 'l', flags: ['heavy']}, {name: 'Hardware organizer', size: 'm', flags: ['sharp']}, {name: 'Tape, glue, utility', size: 's', flags: []}], surface: 'shelf'},
      ...
      {level: 'Floor level', icon: 'down', zone: 'Sports gear · Garden equipment · Large items',
        ...
        eye: false, shelfIndex: 4,
        safety: {flag: null, why: null},
        items: [{name: 'Sports equipment', size: 'l', flags: []}, {name: 'Garden tools', size: 'l', flags: ['sharp']}, {name: 'Buckets & large items', size: 'l', flags: []}], surface: 'floor'}
    ],
    geometry: {unit: 'in', width: 48, height: 72, depth: 18, shelfCount: 5, shelfYFracs: [0.08, 0.28, 0.48, 0.70, 0.92], estimated: true},
    layout: {type: 'garage-rack'},
    safetyNotes: [
  ...
  return {
    ...
    map: [
      {level: 'Top shelf', icon: 'up', zone: 'Backup supplies · Bulk detergent · Rarely used items',
        ...
        items: [{name: 'Bulk detergent', size: 'l', flags: ['heavy', 'chemical']}, {name: 'Backup supplies', size: 'm', flags: ['chemical']}, {name: 'Specialty wash', size: 's', flags: []}], surface: 'shelf'},
      {level: 'Eye level', icon: 'eye', zone: 'Active detergent · Softener · Dryer sheets · Stain kit',
        ...
        eye: true, shelfIndex: 1,
        safety: {flag: null, why: null},
        items: [{name: 'Detergent', size: 'm', flags: ['chemical']}, {name: 'Fabric softener', size: 'm', flags: ['chemical']}, {name: 'Stain removal kit', size: 's', flags: ['chemical']}], surface: 'shelf'},
      {level: 'Middle shelf', icon: 'middle', zone: 'Towels · Washcloths · Cleaning rags',
        ...
        eye: false, shelfIndex: 2,
        safety: {flag: null, why: null},
        items: [{name: 'Towels', size: 'l', flags: []}, {name: 'Washcloths', size: 's', flags: []}, {name: 'Cleaning rags', size: 's', flags: []}], surface: 'shelf'},
  ...
  return {
    ...
    map: [
      ...
      {level: 'Eye level (kid height)', icon: 'eye', zone: 'Books · Coloring books · Favorite toys',
        ...
        eye: true, shelfIndex: 1,
        safety: {flag: null, why: null},
        items: [{name: 'Books', size: 'm', flags: ['kid-frequent']}, {name: 'Coloring & activity books', size: 'm', flags: ['kid-frequent']}, {name: 'Favorite toys', size: 's', flags: ['kid-frequent']}], surface: 'shelf'},
      {level: 'Lower shelf', icon: 'down', zone: 'Building blocks · Large toys · Stuffed animals',
        ...
        eye: false, shelfIndex: 2,
        safety: {flag: null, why: null},
        items: [{name: 'Building blocks', size: 'l', flags: ['heavy', 'kid-frequent']}, {name: 'Large toys', size: 'l', flags: ['kid-frequent']}, {name: 'Stuffed animals', size: 'l', flags: ['kid-frequent']}], surface: 'shelf'},
      {level: 'Floor / hooks', icon: 'down', zone: 'Dress-up · Art caddy · School supplies',
        ...
        eye: false, shelfIndex: 3,
        safety: {flag: null, why: null},
        items: [{name: 'Dress-up & costumes', size: 'l', flags: ['kid-frequent']}, {name: 'Art supply caddy', size: 'm', flags: ['kid-frequent']}, {name: 'School supplies', size: 's', flags: ['kid-frequent']}], surface: 'floor'}
    ],
  ...
  return {
    ...
    map: [
      {level: 'Top shelf', icon: 'up', zone: 'Memorabilia · Keepsakes · Archive documents',
        ...
        items: [{name: 'Memorabilia boxes', size: 'l', flags: []}, {name: 'Archived documents', size: 'm', flags: []}, {name: 'Photo albums', size: 'm', flags: ['fragile']}], surface: 'shelf'},
      {level: 'Upper shelf', icon: 'layers', zone: 'Off-season decorations · Out-of-rotation items',
        ...
        eye: false, shelfIndex: 1,
        safety: {flag: null, why: null},
        items: [{name: 'Off-season holiday bins', size: 'l', flags: []}, {name: 'Outgrown clothes', size: 'l', flags: []}, {name: 'Extra bedding', size: 'l', flags: []}], surface: 'shelf'},
      {level: 'Eye level', icon: 'eye', zone: 'Current-season decorations · Frequently accessed items',
        ...
        eye: true, shelfIndex: 2,
        safety: {flag: null, why: null},
        items: [{name: 'Current-season decorations', size: 'l', flags: []}, {name: 'Gift wrap & bags', size: 'm', flags: []}, {name: 'Party supplies', size: 'm', flags: []}], surface: 'shelf'},
      {level: 'Lower shelf', icon: 'down', zone: 'Camping gear · Sports equipment · Heavy items',
        ...
        eye: false, shelfIndex: 3,
        safety: {flag: null, why: null},
        items: [{name: 'Camping gear', size: 'l', flags: ['heavy']}, {name: 'Sports equipment', size: 'l', flags: []}, {name: 'Coolers & large items', size: 'l', flags: ['heavy']}], surface: 'shelf'},
      {level: 'Floor / rafters', icon: 'down', zone: 'Luggage · Large seasonal items · Overflow',
        ...
        eye: false, shelfIndex: 4,
        safety: {flag: null, why: null},
        items: [{name: 'Luggage', size: 'l', flags: ['heavy']}, {name: 'Large seasonal items', size: 'l', flags: []}, {name: 'Overflow bins', size: 'l', flags: []}], surface: 'floor'}
    ],
  ...
  return {
    ...
    map: [
      {level: 'Top shelf', icon: 'up', zone: 'Seasonal items · Rarely needed supplies',
        ...
        eye: false, shelfIndex: 0,
        safety: {flag: null, why: null},
        items: [{name: 'Seasonal items', size: 'l', flags: []}, {name: 'Rarely used supplies', size: 'm', flags: []}, {name: 'Archived items', size: 'm', flags: []}], surface: 'shelf'},
      {level: 'Eye level', icon: 'eye', zone: 'Frequently used items · Daily essentials',
        ...
        eye: true, shelfIndex: 1,
        safety: {flag: null, why: null},
        items: [{name: 'Daily essentials', size: 'm', flags: []}, {name: 'Office supplies', size: 's', flags: []}, {name: 'Household tools', size: 'm', flags: []}], surface: 'shelf'},
      {level: 'Middle shelf', icon: 'middle', zone: 'Backup supplies · Craft items · Electronics',
        ...
        eye: false, shelfIndex: 2,
        safety: {flag: null, why: null},
        items: [{name: 'Backup supplies', size: 'm', flags: []}, {name: 'Craft supplies', size: 'm', flags: []}, {name: 'Cables & electronics', size: 's', flags: ['fragile']}], surface: 'shelf'},
      {level: 'Lower shelf', icon: 'down', zone: 'Heavy items · Large containers · Overflow',
        ...
        eye: false, shelfIndex: 3,
        safety: {flag: null, why: null},
        items: [{name: 'Heavy items', size: 'l', flags: ['heavy']}, {name: 'Large containers', size: 'l', flags: []}, {name: 'Overflow bin', size: 'l', flags: []}], surface: 'shelf'}
    ],
  ...
  return {
    ...
    map: [
      {level: 'Top drawer', icon: 'up', zone: 'Everyday utensils · Measuring tools',
        ...
        safety: {flag: null, why: null},
        items: [{name: 'Everyday utensils', size: 's', flags: []}, {name: 'Measuring tools', size: 's', flags: []}], surface: 'drawer'},
      {level: 'Second drawer', icon: 'middle', zone: 'Cooking tools · Sharp tools together',
        ...
        items: [{name: 'Cooking tools', size: 's', flags: []}, {name: 'Sharp tools', size: 's', flags: ['sharp']}], surface: 'drawer'},
      {level: 'Third drawer', icon: 'middle', zone: 'Kitchen towels · Foil & wraps',
        ...
        eye: false, shelfIndex: 2,
        safety: {flag: null, why: null},
        items: [{name: 'Kitchen towels', size: 'm', flags: []}, {name: 'Foil & wraps', size: 's', flags: []}], surface: 'drawer'},
      {level: 'Deep bottom drawer', icon: 'down', zone: 'Food storage containers with lids · Bulky gadgets',
        ...
        items: [{name: 'Containers & lids', size: 'm', flags: []}, {name: 'Bulky gadgets', size: 'm', flags: []}], surface: 'drawer'}
    ],
    geometry: {unit: 'in', width: 24, height: 30, depth: 20, shelfCount: 4, shelfYFracs: [0.14, 0.38, 0.62, 0.86], estimated: true},
    layout: {type: 'drawer-bank'},
    safetyNotes: [
  ...
  return {
    ...
    map: [
      {level: 'The drawer', icon: 'middle', zone: 'Tools & tape · Batteries · Pens · Cables · Spares',
        ...
        eye: true, shelfIndex: 0,
        safety: {flag: null, why: null},
        items: [{name: 'Small tools', size: 's', flags: ['sharp']}, {name: 'Batteries', size: 's', flags: []}, {name: 'Pens & tape', size: 's', flags: []}, {name: 'Cables', size: 's', flags: []}], surface: 'drawer'}
    ],
  ...
  return {
    ...
    map: [
      {level: 'Top drawer', icon: 'up', zone: 'Morning routine · Daily skincare',
        ...
        eye: true, shelfIndex: 0,
        safety: {flag: null, why: null},
        items: [{name: 'Daily skincare', size: 's', flags: []}, {name: 'Makeup', size: 's', flags: []}], surface: 'drawer'},
      {level: 'Second drawer', icon: 'middle', zone: 'Hair accessories · First aid basics',
        ...
        eye: false, shelfIndex: 1,
        safety: {flag: null, why: null},
        items: [{name: 'Hair accessories', size: 's', flags: []}, {name: 'First aid', size: 's', flags: []}], surface: 'drawer'},
      {level: 'Cabinet: upper zone', icon: 'vertical', zone: 'Cleaning supplies, up high in a caddy',
        ...
        items: [{name: 'Cleaning sprays', size: 'm', flags: ['chemical']}, {name: 'Chemical refills', size: 'm', flags: ['chemical']}], surface: 'shelf'},
  ...
  return {
    ...
    map: [
      {level: 'Top shelf', icon: 'up', zone: 'Blankets · Duvets · Seasonal bedding',
        ...
        items: [{name: 'Blankets', size: 'l', flags: []}, {name: 'Seasonal bedding', size: 'l', flags: []}], surface: 'shelf'},
      {level: 'Eye level', icon: 'eye', zone: 'Bath towels · Hand towels, in two short stacks',
        ...
        eye: true, shelfIndex: 1,
        safety: {flag: null, why: null},
        items: [{name: 'Bath towels', size: 'm', flags: []}, {name: 'Hand towels', size: 's', flags: []}], surface: 'shelf'},
      {level: 'Middle shelf', icon: 'middle', zone: 'Sheet sets, folded into their pillowcases, by bed size',
        ...
        eye: false, shelfIndex: 2,
        safety: {flag: null, why: null},
        items: [{name: 'Queen sets', size: 'm', flags: []}, {name: 'Twin sets', size: 'm', flags: []}, {name: 'Guest sets', size: 'm', flags: []}], surface: 'shelf'},
      {level: 'Lower shelf', icon: 'down', zone: 'Toiletry backstock · First-aid overflow, in labeled bins',
        ...
        eye: false, shelfIndex: 3,
        safety: {flag: null, why: null},
        items: [{name: 'Toiletry backstock', size: 'm', flags: []}, {name: 'First-aid overflow', size: 's', flags: []}], surface: 'shelf'},
      {level: 'Floor', icon: 'down', zone: 'Beach towels bin · Heating pads · Bulky extras',
        ...
        items: [{name: 'Beach towels', size: 'l', flags: []}, {name: 'Heating pads', size: 's', flags: []}], surface: 'floor'}
    ],
  ...
  return {
    ...
    map: [
      {level: 'Top shelf', icon: 'up', zone: 'Drinks · Ready-to-eat items',
        ...
        eye: false, shelfIndex: 0,
        safety: {flag: null, why: null},
        items: [{name: 'Drinks', size: 'l', flags: []}, {name: 'Ready to eat', size: 'm', flags: []}], surface: 'shelf'},
      {level: 'Eye level', icon: 'eye', zone: '“Eat me first” leftovers bin · Dairy & eggs',
        ...
        eye: true, shelfIndex: 1,
        safety: {flag: null, why: null},
        items: [{name: 'Leftovers bin', size: 'm', flags: []}, {name: 'Dairy & eggs', size: 'm', flags: ['fragile']}], surface: 'shelf'},
      {level: 'Lowest shelf', icon: 'down', zone: 'Raw meat & fish, on a tray',
        ...
        items: [{name: 'Raw meat & fish', size: 'm', flags: []}], surface: 'shelf'},
      {level: 'Crisper drawers', icon: 'drawer', zone: 'Leafy greens (high humidity) · Fruit (low humidity)',
        ...
        eye: false, shelfIndex: 3,
        safety: {flag: null, why: null},
        items: [{name: 'Leafy greens', size: 'm', flags: []}, {name: 'Fruit', size: 'm', flags: []}], surface: 'drawer'},
      {level: 'Freezer drawer', icon: 'down', zone: 'Bags filed upright · Meals dated on top',
        ...
        eye: false, shelfIndex: 4,
        safety: {flag: null, why: null},
        items: [{name: 'Frozen vegetables', size: 'm', flags: []}, {name: 'Frozen meals', size: 'm', flags: []}], surface: 'drawer'}
    ],
  ...
  return {
    ...
    map: [
      {level: 'Left wall: high shelf', icon: 'up', zone: 'Seasonal clothing · Spare bedding, in labeled bins',
        ...
        items: [{name: 'Seasonal bins', size: 'l', flags: []}, {name: 'Spare bedding', size: 'l', flags: []}], surface: 'shelf'},
      {level: 'Left wall: hanging rod', icon: 'hook', zone: 'Long items: dresses · Coats · Jumpsuits',
        ...
        eye: false, shelfIndex: 1,
        safety: {flag: null, why: null},
        items: [{name: 'Dresses', size: 'l', flags: []}, {name: 'Coats', size: 'l', flags: []}], surface: 'rod'},
      {level: 'Back wall: eye level', icon: 'eye', zone: 'Daily folded: knits · Tees · Jeans, in two short stacks per cubby',
        ...
        eye: true, shelfIndex: 2,
        safety: {flag: null, why: null},
        items: [{name: 'Knits & tees', size: 'm', flags: []}, {name: 'Jeans', size: 'm', flags: []}], surface: 'shelf'},
      {level: 'Back wall: lower shelves', icon: 'down', zone: 'Bags & purses · Accessories in small bins',
        ...
        eye: false, shelfIndex: 3,
        safety: {flag: null, why: null},
        items: [{name: 'Bags & purses', size: 'm', flags: []}, {name: 'Accessories', size: 's', flags: []}], surface: 'shelf'},
      {level: 'Right wall: double rods', icon: 'hook', zone: 'Short items doubled up: shirts · Skirts · Folded-bar pants',
        ...
        eye: false, shelfIndex: 4,
        safety: {flag: null, why: null},
        items: [{name: 'Shirts', size: 'm', flags: []}, {name: 'Skirts', size: 'm', flags: []}], surface: 'rod'},
      {level: 'Floor: full run', icon: 'down', zone: 'Shoe rack rows · Laundry basket · Step stool',
        ...
        items: [{name: 'Everyday shoes', size: 'm', flags: []}, {name: 'Laundry basket', size: 'l', flags: []}], surface: 'floor'}
    ],
    geometry: {unit: 'in', width: 96, height: 84, depth: 24, shelfCount: 6, shelfYFracs: [0.08, 0.24, 0.42, 0.58, 0.74, 0.92], estimated: true},
    layout: {type: 'walkin-u', sections: [{id: 'left-wall', label: 'Left wall', place: 'left', rows: [0, 1]}, {id: 'back-wall', label: 'Back wall', place: 'back', rows: [2, 3]}, {id: 'right-wall', label: 'Right wall', place: 'right', rows: [4]}, {id: 'floor', label: 'Floor', place: 'floor', rows: [5]}]},
    safetyNotes: [
  ...
  return {
    ...
    map: [
      {level: 'Top surface', icon: 'up', zone: 'Accessories · Daily landing tray',
        ...
        eye: true, shelfIndex: 0,
        safety: {flag: null, why: null},
        items: [{name: 'Accessories', size: 's', flags: []}, {name: 'Daily tray', size: 's', flags: []}], surface: 'worktop'},
      {level: 'Top drawer', icon: 'drawer', zone: 'Underwear & socks · Pajamas',
        ...
        eye: false, shelfIndex: 1,
        safety: {flag: null, why: null},
        items: [{name: 'Underwear & socks', size: 's', flags: []}, {name: 'Pajamas', size: 's', flags: []}], surface: 'drawer'},
      {level: 'Middle drawer', icon: 'drawer', zone: 'Everyday tops · Workout clothes',
        ...
        eye: false, shelfIndex: 2,
        safety: {flag: null, why: null},
        items: [{name: 'Everyday tops', size: 'm', flags: []}, {name: 'Workout clothes', size: 'm', flags: []}], surface: 'drawer'},
      {level: 'Bottom drawer', icon: 'down', zone: 'Pants & jeans · Sweaters',
        ...
        eye: false, shelfIndex: 3,
        safety: {flag: null, why: null},
        items: [{name: 'Pants & jeans', size: 'l', flags: ['heavy']}, {name: 'Sweaters', size: 'l', flags: []}], surface: 'drawer'}
    ],
  ...
  return {
    ...
    map: [
      {level: 'Pegboard wall', icon: 'hook', zone: 'Hand tools · Most-used power tools',
        ...
        eye: true, shelfIndex: 0,
        safety: {flag: null, why: null},
        items: [{name: 'Hand tools', size: 'm', flags: ['sharp']}, {name: 'Go-to power tools', size: 'm', flags: []}], surface: 'pegboard'},
      ...
      {level: 'Bench drawers', icon: 'drawer', zone: 'Screws & fasteners · Batteries & cords',
        ...
        eye: false, shelfIndex: 3,
        safety: {flag: null, why: null},
        items: [{name: 'Screws & fasteners', size: 's', flags: ['sharp']}, {name: 'Batteries & cords', size: 's', flags: []}], surface: 'drawer'},
      {level: 'Below the bench', icon: 'down', zone: 'Heavy power tools · Safety gear',
        ...
        items: [{name: 'Heavy power tools', size: 'l', flags: ['heavy']}, {name: 'Safety gear', size: 'm', flags: []}], surface: 'shelf'}
    ],
